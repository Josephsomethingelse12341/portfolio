        ...
        <div class=" mt-8 my-2 grid grid-cols-2 mx-40 ">
            <div class="bg-white rounded overflow-hidden shadow-lg m-4 mx-20">
                ...
                <div>
                    ...
                    <span class="block text-sm text-gray-500">This app shows the usage of a weather api, allowing the user to input a city of their choice and recieving the weather conditions of that city.</span>
            ...
            <div class="bg-white rounded overflow-hidden shadow-lg m-4 mx-20">
                ...
                <div>
                    ...
                    <span class="block text-sm text-gray-500">For this assignment, I had to make a crud system, allowing users to login and signup. Letting them create, delete, update employees. Requires a bit of knowledge of apollo to run this project, deployment in the github link.</span>
